...
/*   Updated: 2023/10/03 19:20:20 by aet-tass         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	set_lights(t_list **light, t_minirt *s)
{
	*light = s->lights;
}
...
{
	shape->material.ambient = multiply_color_scalar(s->ambient->color, s->ambient->ratio);
}

static void	set_shapes(t_list **shapes, t_minirt *s)
{
...
t_world	*setup_world(t_minirt *s)
{
	t_world	*world;
