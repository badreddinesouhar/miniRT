...
/*   Updated: 2023/08/12 16:54:04 by bsouhar          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
double calculate_quadra(t_minirt *rt, double r,double x,double y,double z)
{
    ...
    double c = (rt->light->xl * rt->light->xl) + (rt->light->yl * rt->light->yl) * (rt->light->zl * rt->light->zl) - r * r;
...
//                     mlx_put_pixel(image, x + t, y + t, 0xFFFFFF);
//                 }
//                 else if (q < 0)
//                 {
//                     printf("ok");
//                     mlx_put_pixel(image, x + t, y + t, 0x000000);
//                 }
//                 z++;
//             }
//             x++;
...
//                 {
//                     t = calculate_t(rt, x, y, z, q);
//                     double nx = x + t * rt->cam->xc;
//                     double ny = y + t * rt->cam->yc;
//                     double nz = z + t * rt->cam->zc;
//                     double dot_product = nx * rt->light->xl + ny * rt->light->yl + nz * rt->light->zl;
//                     int color_value = (int)(dot_product * 255);
...
//                 {
//                     t = calculate_t(rt, x, y, z, q);
//                     double nx = (x + t * rt->cam->xc - rt->sp->sp_idx->x) / r; // Calculate normal vector
//                     double ny = (y + t * rt->cam->yc - rt->sp->sp_idx->y) / r;
//                     double nz = (z + t * rt->cam->zc - rt->sp->sp_idx->z) / r;
//                     double dot_product = nx * rt->light->xl + ny * rt->light->yl + nz * rt->light->zl;
//                     int color_value = (int)(dot_product * 255); // Map shading to color
//                     mlx_put_pixel(image, x, y, create_color(color_value, color_value, color_value));
//                 }
//                 else if (q < 0)
//                 {
//                     // printf("ok\n");
//                     mlx_put_pixel(image, x, y, 0xFFFFFF); // Background color
//                 }
//                 z++;
//             }
//             x++;
